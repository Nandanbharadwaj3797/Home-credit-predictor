...
class DataTransformationConfig:
    ...
    transformed_train_file_path = os.path.join(artifact_dir, 'train.npz')
    transformed_test_file_path = os.path.join(artifact_dir, 'test.npz')
...
class DataTransformation:
    ...
    def initiate_data_transformation(self):
        try:
            ...
            # Save as .npz for ML pipeline (TARGET is not last column, so save separately)
